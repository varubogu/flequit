...
pub async fn add_project_member(
    ...
    match project_member_service.add_member(project_repository, &member).await {
        Ok(_) => {
...
pub async fn remove_project_member(
    ...
    match project_member_service.remove_member(project_repository, &project_id, &user_id).await {
        Ok(_) => {
            Ok(SimpleResponse {
                success: true,
...
pub async fn list_project_members(
    ...
    match project_member_service.list_members(project_repository, &project_id).await {
        Ok(members) => {
...
pub async fn update_member_role(
    ...
    match project_member_service.update_member_role(project_repository, &member).await {
        Ok(_) => {
            Ok(ProjectMemberResponse {
                success: true,
                data: Some(member),
...
pub async fn get_project_statistics(
    ...
    match project_member_service.get_project_statistics(project_repository, &project_id).await {
        Ok(statistics) => {
...
pub async fn can_manage_members(
    ...
    match project_member_service.can_manage_members(project_repository, &project_id, &user_id).await {
