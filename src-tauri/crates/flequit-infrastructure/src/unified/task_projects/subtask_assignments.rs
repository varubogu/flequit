...
#[async_trait]
impl ProjectRelationRepository<SubTaskAssignment, SubTaskId, UserId> for SubTaskAssignmentRepositoryVariant {
...
impl SubTaskAssignmentUnifiedRepository {
    ...
    #[tracing::instrument(level = "trace")]
    pub fn add_automerge_for_save(&mut self, automerge_repo: SubtaskAssignmentLocalAutomergeRepository) {
        self.save_repositories
            .push(SubTaskAssignmentRepositoryVariant::LocalAutomerge(automerge_repo));
    }
    ...
    #[tracing::instrument(level = "trace")]
    pub fn add_automerge_for_search(&mut self, automerge_repo: SubtaskAssignmentLocalAutomergeRepository) {
        self.search_repositories
            .push(SubTaskAssignmentRepositoryVariant::LocalAutomerge(automerge_repo));
    }
...
#[async_trait]
impl ProjectRelationRepository<SubTaskAssignment, SubTaskId, UserId> for SubTaskAssignmentUnifiedRepository {
    #[tracing::instrument(level = "trace")]
    async fn add(&self, project_id: &ProjectId, parent_id: &SubTaskId, child_id: &UserId) -> Result<(), RepositoryError> {
        info!("Adding subtask assignment - project: {}, subtask: {}, user: {}", project_id, parent_id, child_id);
    ...
    #[tracing::instrument(level = "trace")]
    async fn remove(&self, project_id: &ProjectId, parent_id: &SubTaskId, child_id: &UserId) -> Result<(), RepositoryError> {
        info!("Removing subtask assignment - project: {}, subtask: {}, user: {}", project_id, parent_id, child_id);
    ...
    #[tracing::instrument(level = "trace")]
    async fn remove_all(&self, project_id: &ProjectId, parent_id: &SubTaskId) -> Result<(), RepositoryError> {
        info!("Removing all subtask assignments for subtask - project: {}, subtask: {}", project_id, parent_id);
    ...
    #[tracing::instrument(level = "trace")]
    async fn find_relations(&self, project_id: &ProjectId, parent_id: &SubTaskId) -> Result<Vec<SubTaskAssignment>, RepositoryError> {
        info!("Finding subtask assignments - project: {}, subtask: {}", project_id, parent_id);
    ...
    #[tracing::instrument(level = "trace")]
    async fn exists(&self, project_id: &ProjectId, parent_id: &SubTaskId) -> Result<bool, RepositoryError> {
        info!("Checking if subtask assignments exist - project: {}, subtask: {}", project_id, parent_id);
    ...
    #[tracing::instrument(level = "trace")]
    async fn count(&self, project_id: &ProjectId, parent_id: &SubTaskId) -> Result<u64, RepositoryError> {
        info!("Counting subtask assignments for subtask - project: {}, subtask: {}", project_id, parent_id);
    ...
    #[tracing::instrument(level = "trace")]
    async fn find_relation(&self, project_id: &ProjectId, parent_id: &SubTaskId, child_id: &UserId) -> Result<Option<SubTaskAssignment>, RepositoryError> {
        info!("Finding specific subtask assignment - project: {}, subtask: {}, user: {}", project_id, parent_id, child_id);
