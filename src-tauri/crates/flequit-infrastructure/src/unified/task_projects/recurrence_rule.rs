...
impl RecurrenceRuleUnifiedRepository {
    ...
    pub fn add_automerge_for_save(&mut self, automerge_repo: RecurrenceRuleLocalAutomergeRepository) {
        self.save_repositories
            .push(RecurrenceRuleRepositoryVariant::LocalAutomerge(automerge_repo));
    }
    ...
    pub fn add_automerge_for_search(&mut self, automerge_repo: RecurrenceRuleLocalAutomergeRepository) {
        self.search_repositories
            .push(RecurrenceRuleRepositoryVariant::LocalAutomerge(automerge_repo));
    }
}
...
impl ProjectRepository<RecurrenceRule, RecurrenceRuleId> for RecurrenceRuleUnifiedRepository {
    ...
    async fn find_by_id(
        ...
        info!("Finding recurrence rule by ID: {} in project: {}", id, project_id);
    ...
    async fn delete(&self, project_id: &ProjectId, id: &RecurrenceRuleId) -> Result<(), RepositoryError> {
        info!("Deleting recurrence rule with ID: {} in project: {}", id, project_id);
