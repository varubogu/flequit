...
// Cloud Automerge implementation modules would be added here when implemented
...
#[async_trait]
impl Repository<Project, ProjectId> for CloudAutomergeRepository {
...
#[async_trait]
impl Repository<Task, TaskId> for CloudAutomergeRepository {
...
#[async_trait]
impl Repository<SubTask, SubTaskId> for CloudAutomergeRepository {
...
#[async_trait]
impl Repository<Tag, TagId> for CloudAutomergeRepository {
...
#[async_trait]
impl Repository<User, UserId> for CloudAutomergeRepository {
