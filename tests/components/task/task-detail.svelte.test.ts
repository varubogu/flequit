...
describe('TaskDetail Integration', () => {
  ...
  describe('Component Integration', () => {
    ...
    test('should show empty state when no task selected', () => {
      (taskStore as unknown as Record<string, unknown>).selectedTask = null;
      (taskStore as unknown as Record<string, unknown>).selectedSubTask = null;
  ...
  describe('Component Integration Structure', () => {
    test('should integrate all child components when task is selected', () => {
      ...
      (taskStore as unknown as Record<string, unknown>).selectedTask = {
        id: 'task-1',
        title: 'Test Task',
        status: 'not_started'
      };
  ...
  describe('New Task Mode', () => {
    test('should render task detail when in new task mode', () => {
      (taskStore as unknown as Record<string, unknown>).isNewTaskMode = true;
      (taskStore as unknown as Record<string, unknown>).newTaskData = {
        id: 'new-task',
        title: 'New Task',
        description: '',
        status: 'not_started',
