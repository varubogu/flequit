  ...
  describe('エラー状態・エッジケーステスト', () => {
    it('不正な形式のタスクでもエラーにならない', () => {
      const invalidTask = {
        ...
        is_range_date: 'invalid' as any,
        project_id: null as any,
        task_list_id: undefined as any,
        created_at: 'invalid' as any,
        updated_at: null as any,
        sub_tasks: null as any
      };
      
      const props = { ...defaultProps, task: invalidTask as any };
      const { container } = render(TaskItem, { props });
    ...
    it('nullコールバックでもエラーにならない', () => {
      const props = {
        task: mockTask,
        onTaskClick: null as any,
        onSubTaskClick: null as any
      };
