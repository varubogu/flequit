...
describe('TestFormatSection', () => {
  ...
  const defaultProps = {
    ...
    selectedPreset: { id: 1, name: 'Default', format: 'yyyy-MM-dd HH:mm' } as DateTimeFormat,
  ...
  describe('selectedPreset handling', () => {
    ...
    it('should display selectedPreset value', () => {
      render(TestFormatSection, {
        props: {
          ...defaultProps,
          selectedPreset: { id: 2, name: 'Short', format: 'MM/dd/yyyy' } as DateTimeFormat
        }
      });
    ...
    it('should handle preset without format', () => {
      render(TestFormatSection, {
        props: {
          ...defaultProps,
          selectedPreset: { id: 3, name: 'Custom', format: null } as unknown as DateTimeFormat
        }
      });
