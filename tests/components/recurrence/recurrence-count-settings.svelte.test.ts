...
describe('RecurrenceCountSettings', () => {
  ...
  describe('basic rendering', () => {
    ...
    it('should render description text', () => {
      ...
      expect(screen.getByText('Empty field means the recurrence will continue indefinitely')).toBeInTheDocument();
    });
  });
  ...
  describe('value handling', () => {
    it('should display empty field when value is undefined', () => {
      const { container } = render(RecurrenceCountSettings, { props: { ...defaultProps, value: undefined } });
    ...
    it('should display numeric value when provided', () => {
      const { container } = render(RecurrenceCountSettings, { props: { ...defaultProps, value: 5 } });
    ...
    it('should handle zero value', () => {
      const { container } = render(RecurrenceCountSettings, { props: { ...defaultProps, value: 0 } });
    ...
    it('should handle large numbers', () => {
      const { container } = render(RecurrenceCountSettings, { props: { ...defaultProps, value: 999999 } });
    ...
    it('should sync with prop changes', () => {
      const { container, rerender } = render(RecurrenceCountSettings, { props: { ...defaultProps, value: 5 } });
