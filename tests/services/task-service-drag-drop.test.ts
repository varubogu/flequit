...
import {
  TaskOperations,
  type TaskOperationsDependencies
} from '$lib/services/domain/task/task-operations';
...
describe('TaskOperations - Drag & Drop 相当機能', () => {
  ...
  describe('addTagToTask', () => {
    it('タスクにタグを追加する（バックエンド連携含む）', async () => {
      ...
      expect(TaggingService.createTaskTag).toHaveBeenCalledWith('project-1', 'task-1', 'Work');
