# Flequit Codex Skills

Project-specific Codex skills for Flequit.

## Skill list

| Skill | Purpose | Entry doc |
| --- | --- | --- |
| `project-orientation` | App overview / tech stack / docs index | `docs/ja/develop/design/architecture.md` |
...
- Reusable cross-project workflows belong in user-level skills (`~/.codex/skills/`).
- Skills should be selected based on the user request.
