...
>
  <SwitchPrimitive.Thumb
    ...
    class={cn(
      'bg-background pointer-events-none block size-4 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-1.5 data-[state=unchecked]:translate-x-0'
    )}
  />
</SwitchPrimitive.Root>
